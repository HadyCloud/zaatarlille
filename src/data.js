  ...
  sections: [
    {
      ...
      items: [
        ...
        { id: 'zaatar-labneh-legumes', name: 'Zaatar labneh et légumes', price: 6, veg: true },
        { id: 'labneh-sesame', name: 'Labneh sésame', price: 6.5, veg: true },
        { id: 'jebne', name: 'Jebné', price: 5.5, veg: true,
    ...
    },
    {
      ...
      items: [
        { id: 'mini-pizza', name: 'Mini pizza', price: 1.5, photo: 'minipizza' },
        { id: 'mini-zaatar', name: 'Mini zaatar', price: 1, veg: true },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'dinde-fromage', name: 'Dinde et fromage', price: 9 },
    ...
    {
      id: 'desserts', num: 'IV', pre: 'Nos', title: 'Desserts', post: '',
      script: '',
      label: { fr: 'Desserts', en: 'Desserts', es: 'Postres' },
      cover: 'knefe_chef', itemPrefix: '',
      items: [
        { id: 'knefeh', name: 'Knefeh', price: 7, veg: true, photo: 'knefe_chef',
    ...
    {
      id: 'boissons', num: 'V', pre: '', title: 'Boissons', post: 'Froides',
      script: 'Des couches de plaisir',
      label: { fr: 'Boissons', en: 'Cold drinks', es: 'Bebidas frías' },
